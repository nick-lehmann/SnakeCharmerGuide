"""
We have some students and know how old they are.
Mike is 19, Peter is 20, Michelle is 22 and Nicole is 20.
...
Bonus Points: Choose a name and check if there is a student with that name.
Bonus Bonus Points: Find the oldest student and print their name and age.
"""
